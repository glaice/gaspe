                ...
                <div id="menu">
                    <ul id="menu-ul" class="menu-ul"> 
                        ...
                        <li class="menu-vermelho menu">
                            ...
                            <ul>
                                <li><a href="fotosRetiros.php">Retiros</a></li>
                                <li><a href="fotosOutrosEventos.php">Outros eventos</a></li>
                            </ul></li>
                        <li class="menu-vermelho menu">
                        ...
                        <li class="menu-cinza"><a href="mensagem_paroco.php">Mensagem do Pároco</a></li>
